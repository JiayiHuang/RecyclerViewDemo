 ...
 */
public class MyStaggeredAdapter extends RecyclerView.Adapter<MyStaggeredAdapter.ListViewHolder> {
    private Context mContext;
    private ArrayList<DataBean> mDBList;
    public MyStaggeredAdapter(Context context, ArrayList<DataBean> mDBList){
